...
import ResenasOferente from "./pages/reviews/ResenasOferente";
import ModerarResenas from "./pages/reviews/ModerarResenas";
import MisReportes from "./pages/reviews/MisReportes";
      ...
      <Router>
        <Routes>
          ...
          <Route
            path="/mis-resenas"
            element={
              <RequireRole allowedRoles={["turista"]}>
                <MisResenas />
              </RequireRole>
            }
          />
          ...
          <Route
            path="/oferente/:id_oferente/resenas"
            element={
              <RequireRole allowedRoles={["oferente", "admin"]}>
                <ResenasOferente />
              </RequireRole>
            }
          />
...
<Route path="/admin/dashboard" element={
    <RequireRole allowed={['admin']}>
        <AdminDashboard />
         ...
         <Route path="/admin/moderar-resenas" element={
    <RequireRole allowed={['admin']}>
        <ModerarResenas />
    </RequireRole>
} />
          <Route
            path="/perfil/resenas-negocio"
            element={
              <RequireRole allowed={["oferente"]}>
                <ResenasOferente />
              </RequireRole>
            }
          />

          <Route path="/perfil/mis-reportes" element={
    <RequireRole allowed={['oferente', 'admin']}>
        <MisReportes />
    </RequireRole>
